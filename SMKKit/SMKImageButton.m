...
#import "SMKImageButton.h"

@interface SMKImageButton()
...
- (void)createTitle:(NSString *)titleText withIcon:(UIImage *)iconImage font:(UIFont *)titleFont color:(UIColor *)color iconOffsetY:(CGFloat)iconOffsetY {
    ...
    [self createTitle:titleText withIcon:iconImage font:titleFont iconHeight:iconImage.size.height backgroundColor:color iconOffsetY:iconOffsetY];
}
...
#pragma mark - SMKImageButton logic
- (NSAttributedString *)createStringWithImage:(UIImage *)image string:(NSString *)string color:(UIColor *)color iconPosition:(SMKImageButtonIconSide)iconSide padding:(CGFloat)padding andIconOffsetY:(CGFloat)iconOffsetY {
    
    NSMutableAttributedString *finalString;
    
    if (iconSide == SMKImageButtonIconSideRight) {
        //Right
        ...
        if (padding == SMKImageButtonPaddingSmall) {
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@ ", string] attributes:attributes];
        } else if (padding == SMKImageButtonPaddingMedium){
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@  ", string] attributes:attributes];
        } else if (padding == SMKImageButtonPaddingBig){
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@   ", string] attributes:attributes];
        } else {
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@", string] attributes:attributes];
        }
        ...
        if (padding == SMKImageButtonPaddingSmall && _iconImage) {
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" %@", string] attributes:attributes];
        } else if (padding == SMKImageButtonPaddingMedium && _iconImage){
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"  %@", string] attributes:attributes];
        } else if (padding == SMKImageButtonPaddingBig && _iconImage){
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"   %@", string] attributes:attributes];
        } else {
            aString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@", string] attributes:attributes];
        }
...
- (void)setIconHeight:(CGFloat)iconHeight {
    ...
    if (iconHeight == SMKImageButtonIconHeightDefault) {
...
- (void)setPadding:(SMKImageButtonPadding)padding {
    _padding = padding;
    [self initialize];
}
...
- (void)setIconSide:(SMKImageButtonIconSide)iconSide {
    _iconSide = iconSide;
    [self initialize];
}
